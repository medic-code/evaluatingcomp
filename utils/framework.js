module.exports = {
    ...
    opportunities: "What are the opportunities for {product}. In other words given the products unfair advantage what are the opportunities for {product} to make money",
    risk: "What are the risks for {product}. In other words what are the risks to the business that means the business might fail.",
    market_size: 'What is the market size of {product}, in other words what is the total addressable market for {product}',
    competitors: 'Who are the competitors of {product}, if you dont know the answer give a plausible answer'
}